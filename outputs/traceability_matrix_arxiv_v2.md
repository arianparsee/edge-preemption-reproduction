...
| FIG-001 | Fig. 1، صفحه 3 | `[صریح در مقاله]` timeline arrival/bidding/processing | event epochs | system-flow diagram | `[پیشنهاد فنی] visualization/system_timeline.py` | تطبیق ترتیب رخدادها | شکل توضیحی؛ هدف عددی نیست |
