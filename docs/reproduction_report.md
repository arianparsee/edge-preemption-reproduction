# گزارش بازتولید جاری — تا پایان Stage 15-F
...
نزدیک‌ترین شکل واقعاً غیرمسدود Figure 1 مفهومی است؛ داده تجربی یا seed نمی‌خواهد و مدل آن قبلاً
استخراج شده است. نزدیک‌ترین قابلیت ارزیابی‌مانند پس از آن، R1-DIAG-AUX برای histogram
